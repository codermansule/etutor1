...
export default function MarketingError({
  ...
  useEffect(() => {
    captureError(error, { boundary: "marketing-error" });
  }, [error]);
    ...
    <div className="flex min-h-[60vh] items-center justify-center px-4">
      <div className="w-full max-w-md rounded-2xl bg-slate-900 p-8 text-center shadow-xl">
        ...
        <div className="flex items-center justify-center gap-3">
          ...
          <Link
            href="/"
            className="rounded-lg bg-sky-500/10 px-5 py-2.5 text-sm font-medium text-sky-400 transition-colors hover:bg-sky-500/20"
          >
            Go home
          </Link>
        </div>
